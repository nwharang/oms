...
$(function () {
    ...
    var gridGoodsReturnRequests = $('#gridGoodsReturnRequests').dxDataGrid({
        dataSource: [{
            Vendor: "IDP",
            DocNbr: "RP001",
        ...
        stateStoring: {
            enabled: true,
            type: 'localStorage',
            storageKey: 'gridGoodsReturnRequests',
        },
        showBorders: true,
                ...
                buttons: [
                    {
                        ...
                        hint: "View Details",
                        onClick: function (e) {
                            var w = window.open('/POs/GoodsReturnRequests/Details', '_blank');
