$(function () {
    ...
    $("#form").dxForm({
        ...
        items: [
            ...
            {
                itemType: "group",
                items: ["TotalAmntNoTax", "TotalDiscount", "TotalTaxAmt", "TotalLAmt"]
            }
        ]
    });

    const gridGoodsReturnsDetails = $('#gridGoodsReturnsDetails').dxDataGrid({
        ...
        columns: [
            ...
            },
            {
                ...
                dataField: "LineAmtNoTax", width: 160
            },
            {
                caption: "Discount %",
                dataField: "Discount"
            },
            {
                ...
                dataField: "TaxLineAmount", width: 160
            }, {
                caption: "LineAmt",
                dataField: "LineAmt"
            }, {
