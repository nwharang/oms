$(function () {
    ...
    const dataGridInventoryAdjustment = $('#dataGridInventoryAdjustment').dxDataGrid({
        ...
        onExporting(e) {
            ...
            const worksheet = workbook.addWorksheet('InventoryAdjustment');
            ...
            DevExpress.excelExporter.exportDataGrid({
                ...
                workbook.xlsx.writeBuffer().then((buffer) => {
                    saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'InventoryAdjustment.xlsx');
                });
            });
            e.cancel = true;
        },
                ...
                buttons: [
                    {
                        ...
                        hint: "View Details",
                        onClick: function (e) {
                            var w = window.open('/Inventories/InventoryAdjustment/Details', '_blank');
