$(function () {
    ...
    var itemAttrService = window.dMSpro.oMS.mdmService.controllers.itemAttributeValues.itemAttributeValue;
                                ...
                                items: [
                                    {
                                        ...
                                        editorOptions: {
                                            onValueChanged: function (e) {
                                                $('.fieldInventoryUOMId').dxSelectBox("getDataSource");
                                                debugger
                                            }
                                        }
                                    },
                                        ...
                                        items: [
                                            ...
                                            },
                                            {
                                                ...
                                                editorOptions: {
                                                    onValueChanged: function (e) {
                                                        if (e.value == 'LOT') {
                                                            $('.fieldExpiredType').find('div.dx-show-invalid-badge').removeClass('dx-state-disabled');
                                                            $('.fieldExpiredValue').find('div.dx-show-invalid-badge').removeClass('dx-state-disabled');
                                                            $('.fieldIssueMethod').find('div.dx-show-invalid-badge').removeClass('dx-state-disabled');
                                                        }
                                                        else if (e.value == 'NONE') {
                                                            $('.fieldExpiredType').find('div.dx-show-invalid-badge').addClass('dx-state-disabled');
                                                            $('.fieldExpiredValue').find('div.dx-show-invalid-badge').addClass('dx-state-disabled');
                                                            $('.fieldIssueMethod').find('div.dx-show-invalid-badge').removeClass('dx-state-disabled');
                                                        }
                                                        else {
                                                            $('.fieldExpiredType').find('div.dx-show-invalid-badge').addClass('dx-state-disabled');
